...
var busno=sessionStorage.getItem('Data');

  document.getElementById('result1').innerHTML = busno;
  document.getElementById('result2').innerHTML = full_data[busno][2];
  document.getElementById('result3').innerHTML = full_data[busno][1];
  document.getElementById('result4').innerHTML = full_data[busno][3];
